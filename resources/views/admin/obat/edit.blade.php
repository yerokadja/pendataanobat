        ...
        <div class="col-xl">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" @error('nama_obat') is-invalid @enderror value="{{old('nama_obat') ?? $obatrow->nama_obat }}" name="nama_obat" placeholder="Masukan nama obat"/>
                    @error('nama_obat')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control"  @error('penyimpanan') is-invalid @enderror value="{{old('penyimpanan')?? $obatrow->penyimpanan}}" name="penyimpanan" placeholder="Masukaan" />
                    @error('penyimpanan')
                    <div class="text-danger">{{$message}}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" @error('stock') is-invalid @enderror value="{{old('stock')?? $obatrow->stock}}" name="stock" placeholder="Masukan stock obat" />
                    @error('stock')
                    <div class="text-danger">{{$message}}</div>
                    @enderror
                </div>
                ...
                <select class="form-select" @error('kategori') is-invalid @enderror  name="kategori" aria-label="Default select example">
                    ...
                    <option value="Anti depresian">Anti depresian</option>
                    <option value="Anti Radang">Anti Radang</option>
                    <option value="Antibiotik">Antibiotik</option>
                    <option value="Antioksidan">Antioksidan</option>
                    <option value="Hemolitka">Hemolitka</option>

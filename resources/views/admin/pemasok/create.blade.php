...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Pemasok/</span> {{ $page }}</h4>
        <!-- Basic Layout -->
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                        ...
                        <form action="/dashboard/pemasok" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" @error('nama_pemasok') is-invalid @enderror
                                    value="{{ old('nama_pemasok') }}" name="nama_pemasok"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" @error('no_telpon') is-invalid @enderror
                                    value="{{ old('no_telpon') }}" name="no_telpon" placeholder="Masukan Nomor Telpon" />
                                @error('no_telpon')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
